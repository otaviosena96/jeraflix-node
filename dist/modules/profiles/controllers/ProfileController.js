...
// src/modules/profiles/controllers/ProfileController.ts
var ProfileController_exports = {};
__export(ProfileController_exports, {
  default: () => ProfileController
});
module.exports = __toCommonJS(ProfileController_exports);
...
var ProfileController = class {
  async create(req, res) {
    try {
      ...
      const profiles = await import_tsyringe2.container.resolve(ProfileServiceCrud).create(data);
      const status = 201;
      const message = "Opera\xE7\xE3o realizada com sucesso!";
      return res.json({
        status,
        message,
        data: profiles
  ...
  async findByUserId(req, res) {
    try {
      const profiles = await import_tsyringe2.container.resolve(ProfileServiceCrud).findByUserId(req.headers.user_id ? Number(req.headers.user_id) : 0);
      const status = 201;
      const message = "Opera\xE7\xE3o realizada com sucesso!";
      return res.json({
        status,
