  ...
  "node_modules/tsyringe/dist/cjs/reflection-helpers.js"(exports2) {
    ...
    function defineInjectionTokenMetadata(data, transform) {
      return function(target, _propertyKey, parameterIndex) {
        const descriptors2 = Reflect.getOwnMetadata(exports2.INJECTION_TOKEN_METADATA_KEY, target) || {};
        descriptors2[parameterIndex] = transform ? {
          token: data,
          transform: transform.transformToken,
          transformArgs: transform.args || []
        } : data;
        Reflect.defineMetadata(exports2.INJECTION_TOKEN_METADATA_KEY, descriptors2, target);
      };
    }
...
// src/modules/movies/services/SearchMoviesDirectService.ts
var SearchMoviesDirectService_exports = {};
__export(SearchMoviesDirectService_exports, {
  default: () => SearchMoviesDirectService
});
module.exports = __toCommonJS(SearchMoviesDirectService_exports);
...
// src/modules/movies/services/SearchMoviesDirectService.ts
var SearchMoviesDirectService = class {
  ...
  async appendGenreNames(suggestedMovies) {
    return Promise.all(
...
SearchMoviesDirectService = __decorateClass([
  (0, import_tsyringe.injectable)(),
  __decorateParam(0, (0, import_tsyringe.inject)("MovieRepository"))
], SearchMoviesDirectService);
