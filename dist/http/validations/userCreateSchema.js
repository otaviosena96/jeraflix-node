...
// src/http/validations/userCreateSchema.ts
var userCreateSchema_exports = {};
__export(userCreateSchema_exports, {
  userSchema: () => userSchema
});
module.exports = __toCommonJS(userCreateSchema_exports);
var import_joi = __toESM(require_lib4());
var userSchema = import_joi.default.object({
  name: import_joi.default.string().min(3).max(30).required().messages({
    "string.base": "Nome deve ser um texto",
    "string.empty": "Nome n\xE3o pode estar vazio",
    "string.min": "Nome deve ter pelo menos 3 caracteres",
    "string.max": "Nome deve ter no m\xE1ximo 30 caracteres",
    "any.required": "Nome \xE9 um campo obrigat\xF3rio"
  }),
  email: import_joi.default.string().email().required().messages({
    ...
    "any.required": "Email \xE9 um campo obrigat\xF3rio"
  }),
  password: import_joi.default.string().min(6).max(50).required().messages({
    "string.base": "Senha deve ser um texto",
    "string.empty": "Senha n\xE3o pode estar vazia",
    "string.min": "Senha deve ter pelo menos 6 caracteres",
    "string.max": "Senha deve ter no m\xE1ximo 50 caracteres",
    "any.required": "Senha \xE9 um campo obrigat\xF3rio"
  }),
  birth_date: import_joi.default.date().iso().required().messages({
    "date.base": "A data de nascimento deve ser uma data v\xE1lida",
    "date.iso": "A data de nascimento deve estar no formato ISO 8601",
    "any.required": "A data de nascimento \xE9 um campo obrigat\xF3rio"
  }),
  color: import_joi.default.string().pattern(/^#[0-9A-F]{6}$/i).required().messages({
    "string.base": "A cor deve ser um texto",
    "string.empty": "A cor n\xE3o pode estar vazia",
    "string.pattern.base": "A cor deve estar no formato hexadecimal",
    "any.required": "A cor \xE9 um campo obrigat\xF3rio"
  })
});
